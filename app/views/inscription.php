<form id="formAuthentication" class="mb-3" action="<?= constant('BASE_URL')?>inscription" method="POST">
  <div class="mb-3">
  ...
  <div class="mb-3">
    <a href="<?= constant('BASE_URL')?>" class="btn btn-primary d-grid w-100">Se connecter</a>
  </div>
</form>
